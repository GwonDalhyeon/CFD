...
public:
	...
	static double *orth_random(int n, int &seed);
	static double *pds_random(int n, int &seed);
	static double r8_normal_01(int &seed);
	static double r8_sign(double x);
	static double r8_uniform_01(int &seed);

	static void r83_cg(int n, double a[], double b[], double x[]);
	static double *r83_dif2(int m, int n);
	static double *r83_mv(int m, int n, double a[], double x[]);
	static double *r83_res(int m, int n, double a[], double x[], double b[]);

	static void r83s_cg(int n, double a[], double b[], double x[]);
	static double *r83s_dif2(int m, int n);
	static double *r83s_mv(int m, int n, double a[], double x[]);
	static double *r83s_res(int m, int n, double a[], double x[], double b[]);

	static void r83t_cg(int n, double a[], double b[], double x[]);
	static double *r83t_dif2(int m, int n);
	static double *r83t_mv(int m, int n, double a[], double x[]);
	static double *r83t_res(int m, int n, double a[], double x[], double b[]);

	static void r8ge_cg(int n, double a[], double b[], double x[]);
	static double *r8ge_dif2(int m, int n);
	static double *r8ge_mv(int m, int n, double a[], double x[]);
	static double *r8ge_res(int m, int n, double a[], double x[], double b[]);

	static void r8mat_copy(int m, int n, double a1[], double a2[]);
	static void r8mat_house_axh(int n, double a[], double v[]);
	static double *r8mat_identity_new(int n);
	...
	static void r8pbu_cg(int n, int mu, double a[], double b[], double x[]);
	static double *r8pbu_dif2(int m, int n, int mu);
	static double *r8pbu_mv(int m, int n, int mu, double a[], double x[]);
	static double *r8pbu_res(int m, int n, int mu, double a[], double x[], double b[]);

	static void r8sd_cg(int n, int ndiag, int offset[], double a[], double b[],
		double x[]);
	static double *r8sd_dif2(int m, int n, int ndiag, int offset[]);
	static double *r8sd_mv(int m, int n, int ndiag, int offset[], double a[], double x[]);
	static double *r8sd_res(int m, int n, int ndiag, int offset[], double a[],
		double x[], double b[]);

	static void r8sp_cg(int n, int nz_num, int row[], int col[], double a[],
		double b[], double x[]);
	static double *r8sp_dif2(int m, int n, int nz_num, int row[], int col[]);
	static double *r8sp_mv(int m, int n, int nz_num, int row[], int col[],
		double a[], double x[]);
	static double *r8sp_res(int m, int n, int nz_num, int row[], int col[], double a[],
		double x[], double b[]);

	static void r8vec_copy(int n, double a1[], double a2[]);
	static double r8vec_dot_product(int n, double a1[], double a2[]);
	static double *r8vec_house_column(int n, double a[], int k);
	static double r8vec_norm(int n, double a[]);
	static double r8vec_norm_affine(int n, double a[], double b[]);
	static void r8vec_print(int n, double a[], string title);
	static double *r8vec_uniform_01_new(int n, int &seed);
	static double *r8vec_zero_new(int n);
...
inline int CGLib::i4_min(int i1, int i2)
...
inline double* CGLib::orth_random(int n, int &seed)
...
#pragma omp parallel for
	...
	//
	x = new double[n];
	//#pragma omp parallel for private(v,x)
	for (int j = 0; j < n - 1; j++)
	{
		//
...
inline double* CGLib::pds_random(int n, int &seed)
...
inline double CGLib::r8_normal_01(int &seed)
...
inline double CGLib::r8_sign(double x)
...
inline double CGLib::r8_uniform_01(int &seed)
...
inline void CGLib::r83_cg(int n, double a[], double b[], double x[])
...
inline double* CGLib::r83_dif2(int m, int n)
...
inline double* CGLib::r83_mv(int m, int n, double a[], double x[])
...
inline double* CGLib::r83_res(int m, int n, double a[], double x[], double b[])
...
inline void CGLib::r83s_cg(int n, double a[], double b[], double x[])
...
inline double* CGLib::r83s_dif2(int m, int n)
...
inline double* CGLib::r83s_mv(int m, int n, double a[], double x[])
...
inline double* CGLib::r83s_res(int m, int n, double a[], double x[], double b[])
...
inline void CGLib::r83t_cg(int n, double a[], double b[], double x[])
...
inline double* CGLib::r83t_dif2(int m, int n)
...
inline double* CGLib::r83t_mv(int m, int n, double a[], double x[])
...
inline double* CGLib::r83t_res(int m, int n, double a[], double x[], double b[])
...
inline void CGLib::r8ge_cg(int n, double a[], double b[], double x[])
...
inline double* CGLib::r8ge_dif2(int m, int n)
...
inline double* CGLib::r8ge_mv(int m, int n, double a[], double x[])
...
inline double* CGLib::r8ge_res(int m, int n, double a[], double x[], double b[])
...
inline void CGLib::r8mat_copy(int m, int n, double a1[], double a2[])
...
inline void CGLib::r8mat_house_axh(int n, double a[], double v[])
...
//
{
	...
	v_normsq = 0.0;
#pragma omp parallel for reduction(+:v_normsq)
	for (int i = 0; i < n; i++)
	{
...
inline double* CGLib::r8mat_identity_new(int n)
...
inline void CGLib::r8mat_print(int m, int n, double a[], string title)
...
inline void CGLib::r8mat_print_some(int m, int n, double a[], int ilo, int jlo, int ihi,
	int jhi, string title)
...
inline double* CGLib::r8mat_zero_new(int m, int n)
...
inline void CGLib::r8pbu_cg(int n, int mu, double a[], double b[], double x[])
...
inline double* CGLib::r8pbu_dif2(int m, int n, int mu)
...
inline double* CGLib::r8pbu_mv(int m, int n, int mu, double a[], double x[])
...
inline double* CGLib::r8pbu_res(int m, int n, int mu, double a[], double x[], double b[])
...
inline void CGLib::r8sd_cg(int n, int ndiag, int offset[], double a[], double b[],
	double x[])
...
inline double* CGLib::r8sd_dif2(int m, int n, int ndiag, int offset[])
...
inline double* CGLib::r8sd_mv(int m, int n, int ndiag, int offset[], double a[],
	double x[])
...
inline  double* CGLib::r8sd_res(int m, int n, int ndiag, int offset[], double a[],
	double x[], double b[])
...
inline void CGLib::r8sp_cg(int n, int nz_num, int row[], int col[], double a[],
	double b[], double x[])
...
inline double* CGLib::r8sp_dif2(int m, int n, int nz_num, int row[], int col[])
...
inline double* CGLib::r8sp_mv(int m, int n, int nz_num, int row[], int col[],
	double a[], double x[])
...
inline double* CGLib::r8sp_res(int m, int n, int nz_num, int row[], int col[], double a[],
	double x[], double b[])
...
inline void CGLib::r8vec_copy(int n, double a1[], double a2[])
...
inline double CGLib::r8vec_dot_product(int n, double a1[], double a2[])
...
inline double* CGLib::r8vec_house_column(int n, double a[], int k)
...
inline double CGLib::r8vec_norm(int n, double a[])
...
inline double CGLib::r8vec_norm_affine(int n, double v0[], double v1[])
...
inline void CGLib::r8vec_print(int n, double a[], string title)
...
inline double* CGLib::r8vec_uniform_01_new(int n, int &seed)
...
inline double* CGLib::r8vec_zero_new(int n)
...
inline void CGLib::r8ge_cg_test()
...
inline void CGLib::r83s_cg_test()
...
inline void CGLib::r83t_cg_test()
...
inline void CGLib::r8pbu_cg_test()
...
inline void CGLib::r8sd_cg_test()
...
inline void CGLib::r8sp_cg_test()
